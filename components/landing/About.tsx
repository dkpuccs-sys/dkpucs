const About = () => {
  return (
    <div
      id="about"
      className="w-screen py-24 px-5 sm:px-10 bg-background border-b border-border/50"
    >
