...
/**
 * Renders a button element styled according to the provided variant and size.
 *
 * When `asChild` is set, renders a Slot so callers can supply the actual element while preserving the button styling.
 *
 * @param className - Additional CSS classes to append to the generated classes.
 * @param variant - Visual style variant to apply.
 * @param size - Size variant to apply.
 * @param asChild - If present, render a Slot-wrapped element instead of a native button.
 * @returns A button element or a Slot-wrapped element with the selected variant and size styling applied.
 */
function Button({
  className,
  variant,
